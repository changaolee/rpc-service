...
class _ActionsContainer(object):
    ...
    def add_argument(self, *args, **kwargs):
        ...
        if not args or chars and len(args) == 1 and args[0][0] not in chars:
    ...
    def _get_optional_kwargs(self, *args, **kwargs):
        ...
        for option_string in args:
            ...
            if self.prefix_chars and not option_string[0] in self.prefix_chars:
            ...
            if (
                self.prefix_chars
                and option_string[0] in self.prefix_chars
                or not self.prefix_chars
            ):
                if len(option_string) > 1:
                    if option_string[1] in self.prefix_chars or not self.prefix_chars:
...
class ArgumentParser(_AttributeHolder, _ActionsContainer):
    ...
    def __init__(
        ...
        default_prefix = (
            "-"
            if "-" in prefix_chars
            else ("" if not prefix_chars else prefix_chars[0])
        )
        if self.add_help:
            self.add_argument(
                default_prefix + "h",
        ...
        def consume_optional(start_index):
            ...
            while True:
                ...
                if explicit_arg is not None:
                    ...
                    chars = self.prefix_chars
                    if chars and arg_count == 0 and option_string[1] not in chars:
    ...
    def _parse_optional(self, arg_string):
        ...
        if self.prefix_chars and not arg_string[0] in self.prefix_chars:
            return None
    ...
    def error(self, message):
        ...
        raise Exception(_("file: %(prog)s; error: %(message)s\n") % args)
